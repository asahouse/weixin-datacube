...
@Table(indexes = {
        ...
        }, uniqueConstraints = @UniqueConstraint(name = "UpStreamMsgDistMonth_C_U_R_A_UNIQUE",
        columnNames = {"count_interval", "user_source", "ref_date", "account_id"}))
public class UpStreamMsgDistMonth extends AbstractEntity<UpStreamMsgDistMonth> {
    @Column
